  ...
  if (data !== undefined && data !== null) {
    ...
    listSets = getdata.map((set) => (
      <Link key={set.id} to={"/cards/" + set.id}>
        <Card className="px-2 py-2 ml-2 mb-4 grid w-full shadow-inner shadow-gray-light items-end justify-center overflow-hidden text-center hover:bg-gray-light hover:bg-opacity-40">
          <CardHeader>
            <img
